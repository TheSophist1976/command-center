...
The system SHALL support three priority levels: `high`, `medium`, `low`. The default priority for new tasks SHALL be `medium`.

#### Scenario: Invalid priority
- **WHEN** the user provides a priority value not in {high, medium, low}
